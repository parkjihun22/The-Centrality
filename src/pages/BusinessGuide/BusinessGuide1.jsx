...
const BusinessGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<h1 className={styles.screenReaderOnly}>청주 더센트럴리티 - 사업안내</h1>
			<p className={styles.screenReaderOnly}>
				청주 더센트럴리티는 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다.
			</p>
			...
			<img className={styles.img3} src={page1} alt="청주 더센트럴리티-image1"/>
