            ...
            <div className={styles.section8}>
              <div className={styles.textBox}>
                <div className={styles.title}>
                  소수만 누릴 수 있는<br />
                  <span>최고의 브랜드 아파트<br /> 청주 더센트럴리티</span>
                </div>
              ...
              <img src={section8Img3} alt="청주 더센트럴리티 입지환경소개-image2" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="청주 더센트럴리티 브랜드소개-image4" />
                <div className={styles.text1}>청주 더센트럴리티</div>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="청주 더센트럴리티 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="청주 더센트럴리티 mobilemain-image1"
            />
            <div className={styles.overlay}></div>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="청주 더센트럴리티 mobile입지안내-image1"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 청주 더센트럴리티 <br />
                모델하우스에서 확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="청주 더센트럴리티 mobile조감도-image1"
            />
          </div>
          ...
          <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="청주 더센트럴리티 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="청주 더센트럴리티 오시는길안내-mobileimage2" />
            </div>
          </div> */}
